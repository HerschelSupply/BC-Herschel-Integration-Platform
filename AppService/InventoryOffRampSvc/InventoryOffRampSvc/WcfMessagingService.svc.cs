...
namespace BC.Integration.AppService.InventoryOffRampSvc
{
    ...
    public class WcfMessagingService : IWcfMessagingService
    {
        ...
        {
            Trace.WriteLine("BC.Integration.AppService" + tracingPrefix +" service initializing. ");
            try
            {
            ...
            {
                Trace.WriteLine("BC.Integration.AppService" + tracingPrefix + " service exception occurred. Exception message: " + ex.Message);
            }
            return false;
        }
    }
